...
public class StudentController {
    ...
    public ResponseEntity<String> addStudentTeacherPair(@RequestParam String student, @RequestParam String teacher){
        repoObj.addPairToPairDb(student , teacher);
    ...
    public ResponseEntity<Student> getStudentByName(@PathVariable String name){
        ...
        student  = serviceObj.getStudent(name);
    ...
    public ResponseEntity<Teacher> getTeacherByName(@PathVariable String name){
        ...
        teacher  = serviceObj.getTeacher(name);
    ...
    public ResponseEntity<List<String>> getStudentsByTeacherName(@PathVariable String teacher){
        ...
        students = serviceObj.getNameOfAllStudents(teacher);
    ...
    public ResponseEntity<List<String>> getAllStudents(){
        List<String> students = null; // Assign list of student by calling service layer method
        students  = serviceObj.getAllStudent();
        return new ResponseEntity<>(students, HttpStatus.CREATED);
    }

    @DeleteMapping("/delete-teacher-by-name")
    public ResponseEntity<String> deleteTeacherByName(@RequestParam String teacher){
       repoObj.DeletefromRecord(teacher);
